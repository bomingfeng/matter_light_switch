...
{
    detectIR_Timers = xTimerCreate("detectIR_Timers",180000/portTICK_PERIOD_MS,pdFALSE,( void * ) 4,vdetectIR_TimersCallback);
    led_driver_config_t config1;
    led_driver_init_c3(&config1);
